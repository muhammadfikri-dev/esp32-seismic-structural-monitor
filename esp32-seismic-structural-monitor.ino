/**
 * =========================================================================================
 * Project     : ESP32 Earthquake Seismic Vibration & Building Structural Health Node
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Civil engineering structural monitor with ADXL355 ultra-low noise triaxial accelerometer, calculating Modified Mercalli Intensity (MMI), and triggering elevator stop.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-seismic-structural-monitor";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Earthquake Seismic Vibration & Building Structural Health Node"));
